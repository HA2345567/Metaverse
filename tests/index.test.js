...
describe("Authentication", () => {
    ...
    test("User is able to sign up only once", async () => {
        ...
        try {
            ...
            if (error.response) {
                ...
                throw new Error("No response received in duplicate signup");
            }
        }
    });

    test("Signup request fails if the username is empty", async () => {
        const password = "929929";
        ...
        try {
            ...
            if (error.response) {
                ...
                throw new Error("No response received for empty username signup");
            }
        }
    });
    ...
    test("Signin fails if the username and password are incorrect", async () => {
        const username = `wrong-${Math.random()}`;
        ...
        try {
            ...
            if (error.response) {
                ...
                throw new Error("No response received for failed signin");
            }
        }
    });
});
